...
DEBIAN_PRODUCTS = [
    # ── Installer bootstrap files (kernel + initrd.gz, ~45 MB) ───────────────
    {
        ...
        "group": "installer",
        "version": "12.10.0",
        "name": "Debian 12.10 (Bookworm) Netboot",
        "description": "kernel + initrd.gz for Netboot and Preseed installation.",
        "size_est": "~45 MB",
    ...
    },
    {
        ...
        "group": "installer",
        "version": "13.3.0",
        "name": "Debian 13.3 (Trixie) Netboot",
        "description": "kernel + initrd.gz for Netboot and Preseed installation.",
        "size_est": "~45 MB",
    ...
    # ── Netinst ISOs (~700 MB) ────────────────────────────────────────────────
    {
        ...
        "group": "netinst",
        "version": "12.10.0",
        "name": "Debian 12.10 (Bookworm) Netinst ISO",
        "description": "Small installation ISO for Bookworm. Uses versioned URL (not rolling).",
        "size_est": "~700 MB",
        "dest_folder": "debian-12.10-netinst",
        "iso_url": "https://cdimage.debian.org/cdimage/archive/12.10.0/amd64/iso-cd/debian-12.10.0-amd64-netinst.iso",  # noqa: E501
    ...
    },
    {
        ...
        "group": "netinst",
        "version": "13.3.0",
        "name": "Debian 13.3 (Trixie) Netinst ISO",
        "description": "Small installation ISO. Always points to the current stable release.",
        "size_est": "~700 MB",
    ...
    # ── Live Desktop ISOs (3–4 GB, experimental) ─────────────────────────────
    {
        ...
        "group": "live",
        "version": "13.3.0",
        "name": "Debian 13.3 Live — Xfce",
        "description": "Lightweight Xfce desktop. Includes Calamares graphical installer.",
        "size_est": "~3.0 GB",
    ...
    {
        "id": "debian-13.3-live-lxqt",
        "channel": "stable",
        "kind": "live_iso",
        "group": "live",
        "version": "13.3.0",
        "name": "Debian 13.3 Live — LXQt",
        "description": "Lightweight Qt-based desktop. Good balance of speed and features.",
        "size_est": "~2.8 GB",
        "dest_folder": "debian-13.3-live-lxqt",
        "iso_url": "https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.3.0-amd64-lxqt.iso",
        "files": {"iso": "debian-live-13.3.0-amd64-lxqt.iso"},
        "iso_only": True,
        "experimental": True,
        "boot_targets": ["Debian Live (Experimental)"],
    },
    {
        "id": "debian-13.3-live-mate",
        "channel": "stable",
        "kind": "live_iso",
        "group": "live",
        "version": "13.3.0",
        "name": "Debian 13.3 Live — MATE",
        "description": "Traditional GNOME 2 style desktop. Low resource usage.",
        "size_est": "~3.1 GB",
        "dest_folder": "debian-13.3-live-mate",
        "iso_url": "https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.3.0-amd64-mate.iso",
        "files": {"iso": "debian-live-13.3.0-amd64-mate.iso"},
        "iso_only": True,
        "experimental": True,
        "boot_targets": ["Debian Live (Experimental)"],
    },
    {
        "id": "debian-13.3-live-kde",
        "channel": "stable",
        "kind": "live_iso",
        "group": "live",
        "version": "13.3.0",
        "name": "Debian 13.3 Live — KDE Plasma",
        "description": "Full-featured KDE Plasma desktop. Requires ≥ 8 GB RAM to boot via HTTP ISO.",  # noqa: E501
        "size_est": "~3.8 GB",
        "dest_folder": "debian-13.3-live-kde",
        "iso_url": "https://cdimage.debian.org/debian-cd/current-live/amd64/iso-hybrid/debian-live-13.3.0-amd64-kde.iso",
        "files": {"iso": "debian-live-13.3.0-amd64-kde.iso"},
        "iso_only": True,
        "experimental": True,
        "boot_targets": ["Debian Live (Experimental)"],
    },
    {
        ...
        "group": "live",
        "version": "13.3.0",
        "name": "Debian 13.3 Live — GNOME",
        "description": "Full GNOME desktop. Requires ≥ 8 GB RAM to boot via HTTP ISO.",
        "size_est": "~4.0 GB",
